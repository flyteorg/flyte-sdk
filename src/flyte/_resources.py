...
GPUType = Literal["A10", "A10G", "A100", "A100 80G", "B200", "H100", "L4", "L40s", "T4", "V100"]
...
DeviceClass = Literal["GPU", "TPU", "NEURON", "AMD_GPU"]

_DeviceClassType: Dict[Type[Literal], DeviceClass] = {
    GPUType: "GPU",
    TPUType: "TPU",
    NeuronType: "NEURON",
    AMD_GPUType: "AMD_GPU",
