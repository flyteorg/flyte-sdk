...
class TriggerStatus(_message.Message):
    __slots__ = ["created_at", "updated_at", "activated_at", "triggered_at"]
    ...
    def __init__(self, created_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., updated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., activated_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., triggered_at: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class Trigger(_message.Message):
    ...
    def __init__(self, id: _Optional[_Union[_identifier_pb2.TriggerIdentifier, _Mapping]] = ..., meta: _Optional[_Union[TriggerMetadata, _Mapping]] = ...) -> None: ...
