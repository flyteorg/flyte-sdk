...
class VscodeConfig:
    ...
    code_server_remote_paths: Dict[str, str] = field(default_factory=lambda: DEFAULT_CODE_SERVER_REMOTE_PATHS)
    code_server_dir_names: Dict[str, str] = field(default_factory=lambda: DEFAULT_CODE_SERVER_DIR_NAMES)
    extension_remote_paths: List[str] = field(default_factory=lambda: DEFAULT_CODE_SERVER_EXTENSIONS)
