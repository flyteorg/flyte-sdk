...
async def main() -> list[int]:
    ...
    results_coro_two = []
    for i in range(5):
        results_coro_one.append(
            asyncio.create_task(run_udf.override(short_name="run_udf_parent")(i, add_one_udf))
        )
        results_coro_two.append(
            asyncio.create_task(run_udf.override(short_name="run_udf_inline")(i, fn_add_two_udf))
        )
