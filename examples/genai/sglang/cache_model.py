...
that can be used by the SGLangAppEnvironment.
...
as input to the SGLangAppEnvironment.
"""
...
async def cache_model(
    ...
    be used by the SGLangAppEnvironment.
...
async def main(
    ...
    print("To use this model with SGLangAppEnvironment, set MODEL_PATH to:")
