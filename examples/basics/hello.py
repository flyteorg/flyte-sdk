...
env = flyte.TaskEnvironment(name="hello_world", resources=flyte.Resources(memory="250Mi"), image="356633062068.dkr.ecr.us-east-2.amazonaws.com/union/demo:flyte-09dbb7f26d85ebf9f318e9ca5e024c98")
