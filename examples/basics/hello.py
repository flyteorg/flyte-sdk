...
env = flyte.TaskEnvironment(name="hello_world", resources=flyte.Resources(memory="250Mi"), image="376129846803.dkr.ecr.us-east-2.amazonaws.com/union/dogfood:flyte-39eafabea0c231b2f78bc8c8e1357b62")
