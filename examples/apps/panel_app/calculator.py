"""Panel + Textual Calculator app served as a Flyte AppEnvironment.

This example demonstrates how to serve a Panel app with an embedded Textual
calculator application using the @app_env.server decorator pattern.

Usage (CLI):
    flyte serve --local examples/apps/panel_app/testing.py app_env
"""
...
class CalculatorApp(App):
    ...
    CSS_PATH = (Path(__file__).parent / "calculator.tcss").absolute()
    ...
    NAME_MAP: typing.ClassVar[dict[str, str]] = {
        "asterisk": "multiply",
        "slash": "divide",
...
def create_panel_app():
    """Create the Panel app with the Textual calculator."""
    import panel as pn
...
if __name__ == "__main__":
    ...
    print(f"Calculator app is ready at {app_handle.url}")
