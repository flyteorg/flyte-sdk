...
|---|---|---|---|
| **Task Environments** | Group tasks with shared container config, resources, and images | Define infrastructure once, reuse across tasks | [basics/container_images.py](examples/image/container_images.py) |
