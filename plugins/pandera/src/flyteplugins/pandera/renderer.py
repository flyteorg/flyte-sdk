"""Pandera validation report renderer for Flyte Decks."""
...
class PandasReportRenderer:
    """Renders Pandera validation reports as HTML for Flyte Decks."""

    def __init__(self, title: str = "Pandera Error Report"):
        self._title = title

    def _create_success_report(self, data: "pandas.DataFrame", schema: "pandera.DataFrameSchema") -> PandasReport:
        summary = pandas.DataFrame(
            [
    ...
    @staticmethod
    def _reshape_long_failure_cases(long_failure_cases: "pandas.DataFrame") -> "pandas.DataFrame":
        return (
    ...
    def _format_summary_df(self, df: "pandas.DataFrame") -> str:
        return (
            ...
            .cols_width(cases={"Metadata": "20%", "Value": "80%"})
            .fmt_markdown(["Value"])
    ...
    def _format_data_error_df(self, df: "pandas.DataFrame") -> str:
        ...
        return (
            ...
            .tab_style(
                style=gt.style.text(align="left"),
                locations=[gt.loc.header(), gt.loc.column_labels(), gt.loc.body()],
            )
    ...
    def to_html(
        ...
        if error is None:
            ...
            if report_dfs.schema_error_df is not None:
                error_segments += f"<br>{self._format_schema_error_df(report_dfs.schema_error_df)}"
            if report_dfs.data_error_df is not None:
                error_segments += f"<br>{self._format_data_error_df(report_dfs.data_error_df)}"
        ...
        <body>
            <div class="pandera-report">
                <div class="report-title">
                    <img src="https://raw.githubusercontent.com/pandera-dev/pandera/main/docs/source/_static/pandera-logo.png"
                         alt="Pandera Logo">
