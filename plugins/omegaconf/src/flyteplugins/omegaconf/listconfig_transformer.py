...
class ListConfigTransformer(TypeTransformer[ListConfig]):
    ...
    def from_binary_idl(self, binary_idl_object: Binary, expected_python_type: Type[ListConfig]) -> ListConfig:
    ...
    async def to_python_value(self, lv: Literal, expected_python_type: Type[ListConfig]) -> ListConfig:
