...
@env.task
async def analyze_sensor_data_with_agent(
    prompt: str,
    ...
    task = result.as_task(
        name="run_sensor_analysis_agent",
...
@env.task
async def dataframe_analysis_agent_workflow(
...
if __name__ == "__main__":
    ...
    run = flyte.run(dataframe_analysis_agent_workflow)
    print(f"\nRun URL: {run.url}")
