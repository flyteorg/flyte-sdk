"""Multi-agent research pipeline — Flyte orchestrating many DeepSeek Harness agents.

The "Flyte as the orchestrator harness" story for DeepSeek Harness. Instead of one
agent, a small team is composed with ordinary Flyte control flow, and each agent
...
env = flyte.TaskEnvironment(
    ...
    image=flyte.Image.from_debian_base(name="deepseek-research").with_local_v2_plugins(
