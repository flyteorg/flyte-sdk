"""Multi-agent research pipeline — Flyte orchestrating many LangChain agents.
...
Run:  flyte run langchain_multi_agent.py research_pipeline --topic "The state of electric-vehicle batteries in 2025"
...
env = flyte.TaskEnvironment(
    ...
    image=flyte.Image.from_debian_base(name="langchain-research")
