"""The pydantic_ai adapter must satisfy the shared agent-adapter contract.
...
import flyteplugins.agents.pydantic_ai as adapter


def test_pydantic_ai_adapter_conforms():
