"""Multi-agent research pipeline — Flyte orchestrating many Pydantic AI agents.
...
Run:  flyte run pydantic_ai_multi_agent.py research_pipeline --topic "The state of electric-vehicle batteries in 2025"
...
env = flyte.TaskEnvironment(
    ...
    image=flyte.Image.from_debian_base(name="pydantic-ai-research").with_local_v2_plugins(
