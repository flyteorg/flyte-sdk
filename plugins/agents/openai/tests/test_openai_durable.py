...
from flyteplugins.agents.openai._durable import _request_fingerprint
...
def test_fingerprint_is_deterministic_and_tool_order_insensitive():
    a1 = ("system", "hello", None, [_FakeTool("a"), _FakeTool("b")], None, [])
    a2 = ("system", "hello", None, [_FakeTool("b"), _FakeTool("a")], None, [])
    assert _request_fingerprint(a1, {}) == _request_fingerprint(a2, {})


def test_fingerprint_changes_with_input():
    base = ("system", "hello", None, [], None, [])
    other = ("system", "different", None, [], None, [])
    assert _request_fingerprint(base, {}) != _request_fingerprint(other, {})
