...
Read the logs on a backend — the proof is the tool ``EXECUTED`` lines that DISAPPEAR on
the retry:
...
Run:  python google_crash_resume.py
"""
...
env = flyte.TaskEnvironment(
    ...
    image=(
        flyte.Image.from_debian_base(name="google-crash-resume").clone(
