"""Multi-agent research pipeline — Flyte orchestrating many CrewAI agents.
...
Run:  flyte run crewai_multi_agent.py research_pipeline --topic "The state of electric-vehicle batteries in 2025"
