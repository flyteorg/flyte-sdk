"""Multi-agent research pipeline — Flyte orchestrating many Mistral agents.

The "Flyte as the orchestrator harness" story for Mistral Agents. Instead of one
...
env = flyte.TaskEnvironment(
    ...
    image=flyte.Image.from_debian_base(name="mistral-research").with_local_v2_plugins(
