"""Multi-agent research pipeline — Flyte orchestrating many Hermes agents.
...
Run:  flyte run hermes_multi_agent.py research_pipeline --topic "The state of electric-vehicle batteries in 2025"
...
env = flyte.TaskEnvironment(
    ...
    image=flyte.Image.from_debian_base(name="hermes-research").with_local_v2_plugins(
